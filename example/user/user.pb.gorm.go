...
type UserORM struct {
	Tasks             []*TaskORM          `gorm:"foreignKey:UserId;references:Id" atlas:"position:Priority" json:"tasks,omitempty"`
	Languages         []*LanguageORM      `gorm:"foreignKey:Id;references:Id;many2many:user_languages;joinForeignKey:UserId;joinReferences:LanguageId" json:"languages,omitempty"`
	Friends           []*UserORM          `gorm:"foreignKey:Id;references:Id;many2many:user_friends;joinForeignKey:UserId;joinReferences:FriendId" json:"friends,omitempty"`
	Id                *string             `gorm:"type:uuid;primaryKey" json:"id,omitempty"`
	CreatedAt         null.Time           `json:"created_at,omitempty"`
	ExternalUuid      *string             `gorm:"type:uuid" json:"external_uuid,omitempty"`
	AccountID         string              `json:"account_id,omitempty"`
	UpdatedAt         *time.Time          `json:"updated_at,omitempty"`
	CreditCard        *CreditCard         `gorm:"type:jsonb" json:"credit_card,omitempty"`
	BillingAddress    *AddressORM         `gorm:"type:jsonb;foreignKey:BillingAddressId;references:Id" json:"billing_address,omitempty"`
	Price             decimal.NullDecimal `gorm:"type:numeric" json:"price,omitempty"`
	ShippingAddressId *int64              `json:"shipping_address_id,omitempty"`
	Emails            []*EmailORM         `gorm:"foreignKey:UserId;references:Id" json:"emails,omitempty"`
	BillingAddressId  *int64              `json:"billing_address_id,omitempty"`
	Birthday          *time.Time          `json:"birthday,omitempty"`
	Num               uint32              `json:"num,omitempty"`
	ShippingAddress   *AddressORM         `gorm:"type:jsonb;foreignKey:ShippingAddressId;references:Id" json:"shipping_address,omitempty"`
	Test              null.Uint32         `json:"test,omitempty"`
}
...
func (m *User) ToORM(ctx context.Context) (UserORM, error) {
	...
	if m.Price != nil {
		to.Price = m.Price.ToNullDecimal()
	}
	err = to.Test.Scan(m.Test)
	if err != nil {
		return to, err
	}
...
func (m *UserORM) ToPB(ctx context.Context) (User, error) {
	...
	if m.CreatedAt.IsValid() {
		to.CreatedAt = timestamppb.New(m.CreatedAt.Time)
	}
	if m.UpdatedAt != nil {
	...
	to.Price = gormpb.FromNullDecimal(m.Price)
	to.Test = m.Test.Uint32
...
type EmailORM struct {
	ExternalNotNull *string `gorm:"type:uuid;not null" json:"external_not_null,omitempty"`
	AccountID       string  `json:"account_id,omitempty"`
	Id              *string `gorm:"type:uuid;primaryKey" json:"id,omitempty"`
...
type AddressORM struct {
	ImplicitFk *string `gorm:"type:text" json:"implicit_fk,omitempty"`
	AccountID  string  `json:"account_id,omitempty"`
	Id         *int64  `gorm:"type:integer;primaryKey" json:"id,omitempty"`
	Address_1  string  `json:"address_1,omitempty"`
	Address_2  string  `json:"address_2,omitempty"`
	Post       string  `json:"post,omitempty"`
	External   []byte  `gorm:"type:jsonb" json:"external,omitempty"`
}
...
type LanguageORM struct {
	...
	ExternalInt *int64 `gorm:"type:integer" json:"external_int,omitempty"`
	AccountID   string `json:"account_id,omitempty"`
}
