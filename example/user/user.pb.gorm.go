...
type UserORM struct {
	...
	BillingAddress    *AddressORM    `gorm:"foreignKey:BillingAddressId;references:Id" json:"billing_address,omitempty"`
	BillingAddressId  *int64         `json:"billing_address_id,omitempty"`
	Birthday          *time.Time     `json:"birthday,omitempty"`
	CreatedAt         *time.Time     `json:"created_at,omitempty"`
	CreditCard        *CreditCardORM `gorm:"foreignKey:UserId;references:Id" json:"credit_card,omitempty"`
	...
	ShippingAddress   *AddressORM    `gorm:"foreignKey:ShippingAddressId;references:Id" json:"shipping_address,omitempty"`
