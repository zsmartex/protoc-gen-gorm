...
type WrapperMessage struct {
	...
	BigInt    *BigInt    `protobuf:"bytes,5,opt,name=bigint,json=bigint" json:"bigint,omitempty"`
}
...
func TestSuccessfulUnmarshalTypes(t *testing.T) {
	...
	for in, expected := range map[string]WrapperMessage{
		`{}`: {JSON: nil, UUID: nil, Inet: nil, BigInt: nil},
		...
		`{"bigint":null}`:      {BigInt: &BigInt{Value: ""}},
		`{"bigint":"12345"}`:   {BigInt: &BigInt{Value: "12345"}},
	} {
		jv := WrapperMessage{}
...
func TestBrokenUnmarshalTypes(t *testing.T) {
	...
	for in, expected := range map[string]string{
		...
		`{"bigint": 1}`:                                         "invalid bigint '1' does not match accepted format",
	} {
...
func TestMarshalTypes(t *testing.T) {
	...
	for expected, in := range map[string]WrapperMessage{
		`{"json":null,"uuid_value":null,"uuid":null,"inet":null,"bigint":null}`:                                                     {},
		`{"json":null,"uuid_value":null,"uuid":"00000000-0000-0000-0000-000000000000","inet":null,"bigint":null}`:                   {UUID: &UUID{}},
		`{"json":{"key": "value"},"uuid_value":"6ba7b810-9dad-11d1-80b4-00c04fd430c8","uuid":null,"inet":null,"bigint":null}`:       {JSON: &JSONValue{Value: `{"key": "value"}`}, UUIDValue: &UUIDValue{Value: `6ba7b810-9dad-11d1-80b4-00c04fd430c8`}},
		`{"json":{"key": "value"},"uuid_value":"6ba7b810-9dad-11d1-80b4-00c04fd430c8","uuid":null,"inet":"10.0.0.1","bigint":null}`: {JSON: &JSONValue{Value: `{"key": "value"}`}, UUIDValue: &UUIDValue{Value: `6ba7b810-9dad-11d1-80b4-00c04fd430c8`}, Inet: &InetValue{Value: `10.0.0.1`}},
		`{"json":null,"uuid_value":"00000000-0000-0000-0000-000000000000","uuid":null,"inet":null,"bigint":null}`:                   {UUIDValue: &UUIDValue{Value: "00000000-0000-0000-0000-000000000000"}},
		`{"json":null,"uuid_value":null,"uuid":null,"inet":null,"bigint":"12345"}`:                                                  {BigInt: &BigInt{Value: "12345"}},
	} {
